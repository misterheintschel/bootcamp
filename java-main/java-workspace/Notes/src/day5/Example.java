...
public class Example {
	...
	public static void main(String[] args) {
		...
		/*
		 * The println method of PrintStreams (such as the static 'out' of our System Class) will invoke the toString method on an object
		 * 
		 */
	...
	/*
	 * By default the toString method of objects will print a HashCode* of the Object's reference location
	 * 
	 * *Hashing information is a fancy way of saying 
	 * you will produce a numerical value from some input. 'Proper' Hashing have a few rules:
	 * 
	 * 	-Hashes should always produce a unique 
	 * 		value for the input received
